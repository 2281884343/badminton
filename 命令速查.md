...
sudo systemctl enable badminton-game     # 开机自启
sudo systemctl disable badminton-game    # 禁用自启
...
# 设置永久环境变量（添加到 ~/.bashrc 或 ~/.bash_profile）
